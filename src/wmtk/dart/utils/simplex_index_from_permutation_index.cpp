...
{
    switch (mesh_type) {
    case PrimitiveType::Edge: return edge_mesh::simplex_index_from_permutation_index(permutation_index, type);
    case PrimitiveType::Triangle:
        return tri_mesh::simplex_index_from_permutation_index(permutation_index, type);
    case PrimitiveType::Tetrahedron:
        return tet_mesh::simplex_index_from_permutation_index(permutation_index, type);
