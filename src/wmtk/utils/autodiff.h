...
class numeric_limits<DScalar1<_Scalar, _Gradient>>: public numeric_limits<_Scalar> {};

template <typename _Scalar, typename _Gradient, typename _Hessian>
class numeric_limits<DScalar2<_Scalar, _Gradient, _Hessian>>: public numeric_limits<_Scalar> {};
