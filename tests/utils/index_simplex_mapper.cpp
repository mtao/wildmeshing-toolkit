...
TEST_CASE("index_simplex_mesh_mapper", "[simplex][indexing][dart]")
{
    if (true) {
        ...
        std::array<int64_t, 2> f{{2, 1}};
        {
            auto ad = ism.get_mesh_dart(a);
            auto bd = ism.get_mesh_dart(b);
            auto cd = ism.get_mesh_dart(c);
            auto dd = ism.get_mesh_dart(d);
            auto ed = ism.get_mesh_dart(e);
            auto fd = ism.get_mesh_dart(f);
...

    {
        ...
        }
        {
...

            {
                ...
                auto Dd = ism.get_internal_dart(D);
                auto Ed = ism.get_internal_dart(E);
                CHECK(bd.global_id() == 0);
                CHECK(cd.global_id() == 0);
                CHECK(dd.global_id() == 1);
                CHECK(ed.global_id() == 1);
            ...
            // redundant to the later checks, was used for debug and perhaps will be useful in teh
            // future
            /*
            CHECK(ad.global_id() == 0);
            CHECK(bd.global_id() == 0);
            ...
            CHECK(bd.permutation() == wmtk::tests::dart::utils::d021.permutation());
            CHECK(cd.permutation() == wmtk::tests::dart::utils::d120.permutation());
            CHECK(dd.permutation() == wmtk::tests::dart::utils::d201.permutation());
            CHECK(ed.permutation() == wmtk::tests::dart::utils::d102.permutation());

            CHECK(Ad.permutation() == wmtk::tests::dart::utils::d102.permutation());
            CHECK(Bd.permutation() == wmtk::tests::dart::utils::d201.permutation());
            CHECK(Cd.permutation() == wmtk::tests::dart::utils::d210.permutation());
            CHECK(Dd.permutation() == wmtk::tests::dart::utils::d021.permutation());
            CHECK(Ed.permutation() == wmtk::tests::dart::utils::d012.permutation());
            */


            CHECK((ad == wmtk::dart::Dart(0, wmtk::tests::dart::utils::d012.permutation())));
            CHECK((bd == wmtk::dart::Dart(0, wmtk::tests::dart::utils::d021.permutation())));
            CHECK((cd == wmtk::dart::Dart(0, wmtk::tests::dart::utils::d120.permutation())));
            CHECK((dd == wmtk::dart::Dart(1, wmtk::tests::dart::utils::d201.permutation())));
            CHECK((ed == wmtk::dart::Dart(1, wmtk::tests::dart::utils::d102.permutation())));

            CHECK((Ad == wmtk::dart::Dart(0, wmtk::tests::dart::utils::d102.permutation())));
            CHECK((Bd == wmtk::dart::Dart(0, wmtk::tests::dart::utils::d201.permutation())));
            CHECK((Cd == wmtk::dart::Dart(0, wmtk::tests::dart::utils::d210.permutation())));
            CHECK((Dd == wmtk::dart::Dart(1, wmtk::tests::dart::utils::d021.permutation())));
            CHECK((Ed == wmtk::dart::Dart(1, wmtk::tests::dart::utils::d012.permutation())));
        }
    }
}
