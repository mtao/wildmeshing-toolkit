    ...
    for (PrimitiveType mesh_type :
        ...
        for (const auto& t : tuples) {
            ...
            auto run = [&]() {
                ...
                const dart::Dart expected = sd.dart_from_tuple(product_switch);
        ...
        for (int8_t index = 0; index < sd.size(); ++index) {
            for (PrimitiveType simplex_type :
                ...
                for (int8_t simplex_index = 0; simplex_index < num_simplices; ++simplex_index) {
                    ...
                    auto [act, size] = wmtk::dart::utils::subdart_maximal_action_to_face(
                        mesh_type,
                        index,
                        simplex_type,
                        simplex_index);
                    auto a = wmtk::dart::utils::subdart_maximal_action_to_face_action(
                        mesh_type,
                        index,
                        simplex_type,
                        simplex_index);
                    auto s = wmtk::dart::utils::largest_shared_subdart_size(
                        mesh_type,
                        index,
                        simplex_type,
                        simplex_index);
