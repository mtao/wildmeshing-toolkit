...
{
    //
    WMTK_NLOHMANN_ASSIGN_TYPE_TO_JSON(passes, input, output)
...
{
    WMTK_NLOHMANN_JSON_DECLARE_DEFAULT_OBJECT(Configuration);
    WMTK_NLOHMANN_ASSIGN_TYPE_FROM_JSON(passes, input);
    WMTK_NLOHMANN_ASSIGN_TYPE_FROM_JSON_WITH_DEFAULT(output);
